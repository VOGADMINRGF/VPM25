...
const STRINGS: {
  ...
  disclaimerBody: {
    de: [
      ...
      "Derzeit werden keine Zuwendungsbestätigungen ausgestellt; Beiträge sind in der Regel nicht steuerlich absetzbar.",
      "",
    ...
    en: [
      ...
      "No contribution receipts are currently issued; contributions are generally not tax-deductible.",
      "",
