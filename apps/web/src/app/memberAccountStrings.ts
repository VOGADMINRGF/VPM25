...
type MemberAccountStrings = {
  ...
  account: {
    ...
    vogUpdates: string;
    edebatteUpdates: string;
    supporterBanner: string;
    on: string;
    off: string;
    toMovement: string;
...
const STRINGS: Record<SupportedLocale, MemberAccountStrings> = {
  de: {
    common: {
      brand: "VoiceOpenGov",
      email: "E-Mail",
    ...
    join: {
      ...
      newsletter: "Ich möchte Updates von VoiceOpenGov erhalten.",
      edebatteNewsletter: "Ich möchte zusätzlich Updates zu eDebatte erhalten.",
      ...
      successBadge: "Nächster Schritt",
      successTitle: "Prüfe jetzt deine E-Mail.",
      ...
      missingPrivacy: "Bitte bestätige die Datenschutzhinweise.",
      missingPerson: "Bitte fülle Name und Geburtsdatum vollständig aus.",
      missingOrganisation: "Bitte gib den Namen der Organisation an.",
      failed: "Die Registrierung konnte nicht abgeschlossen werden.",
      ...
      passwordNeedsNumber: "Das Passwort benötigt mindestens eine Zahl.",
      passwordNeedsSpecial: "Das Passwort benötigt mindestens ein Sonderzeichen.",
    },
    login: {
      title: "Anmelden",
      intro: "Der Login ist für bestätigte Mitgliedschaften verfügbar.",
      invalid: "E-Mail oder Passwort sind nicht korrekt – oder die E-Mail wurde noch nicht bestätigt.",
      submit: "Anmelden",
      submitting: "Anmeldung läuft …",
      noMember: "Noch kein Mitglied?",
    },
    account: {
      eyebrow: "Mitgliedskonto",
      loading: "Konto wird geladen …",
      title: "Dein Konto",
      unauthenticated: "Bitte melde dich an, um deinen Mitgliedsstatus zu sehen.",
      logout: "Abmelden",
      status: "Status",
      ...
      region: "Region",
      notSet: "Noch nicht hinterlegt",
      publicSums: "Öffentliche Orts-Summen",
      allowed: "freigegeben",
      notAllowed: "nicht freigegeben",
      communication: "Kommunikation",
      vogUpdates: "VoiceOpenGov Updates",
      edebatteUpdates: "eDebatte Updates",
      supporterBanner: "Unterstützer-Banner",
      on: "an",
      off: "aus",
      toMovement: "Zur Bewegung",
      changePassword: "Passwort ändern",
    },
    password: {
      eyebrow: "Mitgliedszugang",
      setupTitle: "Zugang einrichten",
      ...
      setIntro: "Lege ein neues Passwort für deinen bestätigten Mitgliedszugang fest.",
      emailLabel: "E-Mail deiner Mitgliedschaft",
      requestLink: "Einrichtungslink senden",
      ...
      hint: "Mindestens 12 Zeichen, eine Zahl und ein Sonderzeichen.",
      save: "Passwort speichern",
      saving: "Wird gespeichert …",
      savedTitle: "Passwort gespeichert.",
      savedBody: "Du kannst dich jetzt mit deiner E-Mail-Adresse anmelden.",
      backLogin: "Zurück zum Login",
      mismatch: "Die beiden Passwörter stimmen nicht überein.",
      invalidToken: "Der Link ist ungültig oder abgelaufen. Bitte fordere einen neuen an.",
  ...
  en: {
    ...
    join: {
      ...
      successBadge: "Next step",
      successTitle: "Check your email now.",
      ...
      missingPrivacy: "Please accept the privacy notice.",
      missingPerson: "Please complete your name and date of birth.",
      missingOrganisation: "Please enter the organisation name.",
      failed: "Registration could not be completed.",
      invalidBirthdate: "Please enter a valid date of birth.",
      underage: "Membership is available from age 16.",
      passwordTooShort: "The password must be at least 12 characters long.",
      passwordTooLong: "The password may contain at most 128 characters.",
      passwordNeedsNumber: "The password must contain at least one number.",
      passwordNeedsSpecial: "The password must contain at least one special character.",
    },
    login: {
      title: "Sign in",
      intro: "Sign-in is available for confirmed memberships.",
      invalid: "The email or password is incorrect, or the email has not been confirmed yet.",
      submit: "Sign in",
    ...
    account: {
      ...
      title: "Your account",
      unauthenticated: "Please sign in to view your membership status.",
      logout: "Sign out",
      status: "Status",
      ...
      publicSums: "Public local totals",
      allowed: "enabled",
      notAllowed: "disabled",
      communication: "Communication",
      vogUpdates: "VoiceOpenGov updates",
      edebatteUpdates: "eDebatte updates",
      supporterBanner: "Supporter banner",
      on: "on",
      off: "off",
      toMovement: "Go to the movement",
      changePassword: "Change password",
    },
    password: {
      eyebrow: "Member access",
      setupTitle: "Set up access",
      setTitle: "Set password",
      setupIntro: "This also works for memberships confirmed before the new sign-in was introduced.",
      setIntro: "Set a new password for your confirmed member access.",
      emailLabel: "Membership email",
      requestLink: "Send setup link",
      requesting: "Sending …",
      genericSent: "If an active membership exists for this email, we sent a link to set up the password.",
      newPassword: "New password",
      repeatPassword: "Repeat password",
      hint: "At least 12 characters, one number and one special character.",
      save: "Save password",
      saving: "Saving …",
      savedTitle: "Password saved.",
      savedBody: "You can now sign in with your email address.",
...
export function getMemberAccountStrings(locale: SupportedLocale): MemberAccountStrings {
