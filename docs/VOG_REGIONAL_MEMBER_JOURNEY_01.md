...
- the route inherits the shared VoiceOpenGov locale, translation-status and RTL contract.
...
- VoiceOpenGov draft PR #6: public brand, locale and canonical questions closing pass;
- VoiceOpenGov draft PR #15: this regional activation slice;
